...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        DropBoDao.createTable(db, ifNotExists);
        FileDownLoadDao.createTable(db, ifNotExists);
        GScopeDao.createTable(db, ifNotExists);
        HistoryHouseTagDao.createTable(db, ifNotExists);
        RailLineDao.createTable(db, ifNotExists);
        RailWayDao.createTable(db, ifNotExists);
        RcTokenDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        DropBoDao.dropTable(db, ifExists);
        FileDownLoadDao.dropTable(db, ifExists);
        GScopeDao.dropTable(db, ifExists);
        HistoryHouseTagDao.dropTable(db, ifExists);
        RailLineDao.dropTable(db, ifExists);
        RailWayDao.dropTable(db, ifExists);
        RcTokenDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(DropBoDao.class);
        registerDaoClass(FileDownLoadDao.class);
        registerDaoClass(GScopeDao.class);
        registerDaoClass(HistoryHouseTagDao.class);
        registerDaoClass(RailLineDao.class);
        registerDaoClass(RailWayDao.class);
        registerDaoClass(RcTokenDao.class);
