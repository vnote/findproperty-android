...
import com.cetnaline.findproperty.widgets.tablayout.utils.FragmentChangeManager;
import com.cetnaline.findproperty.widgets.tablayout.utils.UnreadMsgUtils;
import com.cetnaline.findproperty.widgets.tablayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, sp2px(24f));
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrentTab != position) {
                    ...
                    } else if ( mCheckListener != null) {
                        if (!mCheckListener.checkExchange(position))
                            return;
                        else
                            setCurrentTab(position);
                    }
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    private OnCheckExchangeListener mCheckListener;

    public void setOnTabSelectListener(OnTabSelectListener listener) {
        this.mListener = listener;
    }

    public void setCheckListener(OnCheckExchangeListener mCheckListener) {
