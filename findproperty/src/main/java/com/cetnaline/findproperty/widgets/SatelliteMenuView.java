...
/**
 * Created by sunxl8 on 2016/8/18.
 */
public class SatelliteMenuView extends ViewGroup implements OnClickListener {
    ...
    public SatelliteMenuView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
        //获取自定义属性
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.SatellitemenuView, defStyle, 0);
        int pos = a.getInt(R.styleable.SatellitemenuView_position, POS_RIGHT_BOTTOM);
        switch (pos) {
            case POS_LEFT_TOP:
        ...
        mRadius = (int) a.getDimension(R.styleable.SatellitemenuView_radius,
    ...
    public void onClick(View v) {
        if (isOneClick && mStatus == Status.CLOSE) {
            return;
        }
        mCButton = findViewById(R.id.item_big_head);
