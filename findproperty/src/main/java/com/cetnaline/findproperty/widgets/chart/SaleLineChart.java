...
public class SaleLineChart extends LineChart {
    ...
    public SaleLineChart(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SaleLineChart(Context context, AttributeSet attrs, int defStyle) {
...
//        animateX(2500);
     ...
     * 设置数据
     */
    public void setPostInternalBos(String estateName, List<PostInternalBo> gscopeList, List<PostInternalBo> estList) {
        if (gscopeList!=null && gscopeList.size()>0){
            gscopPostInternalBo = gscopeList.get(0);
        }
        if (estList!=null && estList.size()>0){
            estatePostInternalBo = estList.get(0);
        }
...
//            lineDataSet.setdraw
    ...
    public class SaleLineMarkView extends MarkerView {
        ...
        public int getXOffset(float xpos) {
            if (chartWidth == 0) {
                chartWidth = SaleLineChart.this.getWidth();
            }
        ...
        public int getYOffset(float ypos) {
            if (chartHeight == 0) {
                chartHeight = SaleLineChart.this.getHeight();
            }
